...
```bash
npm run backtest:psc
# オプション: --start 2025-01-01 --end 2026-04-15 --budget 500000 --verbose
```
...
- **OOS集計PF=2.72、判定「堅牢 ✓」（IS/OOS比=0.00、OOS > IS）**
- 全7ウィンドウアクティブ（休止なし）
- atr=0.8・be=0.3 が全ウィンドウで安定、trail=0.5 が直近4窓で安定
- OOS総トレード194件、勝率47.4%、平均保有1.3日
