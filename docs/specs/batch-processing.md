...
| order-manager | order-manager.yml | `20 0 * * 1-5` | 平日 9:20 JST | 注文生成（寄付き9:00のデータ反映後） |
| midday-reassessment | midday-reassessment.yml | `15 3 * * 1-5` | 平日 12:15 JST | 昼休み再評価（前場終了11:30のデータ反映後） |
| end-of-day | end-of-day.yml | `50 6 * * 1-5` | 平日 15:50 JST | 日次締め（大引け15:30のデータ反映後） |
...
| daily-backtest | daily-backtest.yml | `30 7 * * 1-5` | 平日 16:30 JST | 日次バックテスト |
| jpx-delisting-sync | jpx-delisting-sync.yml | `0 0 * * 6` | 土曜 9:00 JST | JPX廃止予定同期 |
