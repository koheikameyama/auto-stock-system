...
**詳細フィルター**（ドロップダウン型、市場タブの下に配置）:
- セクター: SECTOR_MASTERの11セクター + すべて
- 期間: 1日以内 / 3日以内 / 7日以内（デフォルト）/ 14日以内 / 30日以内
- センチメント: ポジティブ / ネガティブ / 中立 / すべて

全フィルターはAND条件で組み合わせ可能。
