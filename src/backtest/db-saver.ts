...
import type { BreakoutBacktestResult, GapUpBacktestResult, MomentumBacktestResult, EarningsGapBacktestResult, WeeklyBreakBacktestResult, MaPullbackBacktestResult, GapDownReversalBacktestResult, PostSurgeConsolidationBacktestResult, NR7BacktestResult } from "./types";

type BacktestStrategy = "breakout" | "gapup" | "combined" | "momentum" | "earnings-gap" | "weekly-break" | "ma-pullback" | "gapdown-reversal" | "post-surge-consolidation" | "nr7";
...
export async function saveBacktestResult(
  result: BreakoutBacktestResult | GapUpBacktestResult | MomentumBacktestResult | EarningsGapBacktestResult | WeeklyBreakBacktestResult | MaPullbackBacktestResult | GapDownReversalBacktestResult | PostSurgeConsolidationBacktestResult | NR7BacktestResult,
