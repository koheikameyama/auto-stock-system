/**
 * 高騰後押し目（Post-Surge Consolidation）バックテスト実行スクリプト
 *
 * Usage:
 *   npm run backtest:psc
 *   npm run backtest:psc -- --start 2025-04-01 --end 2026-03-25
 *   npm run backtest:psc -- --verbose
 */
...
import { runPSCBacktest } from "./post-surge-consolidation-simulation";
...
import type { PostSurgeConsolidationBacktestConfig, PerformanceMetrics } from "./types";
